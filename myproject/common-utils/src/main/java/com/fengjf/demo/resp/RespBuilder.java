...
public class RespBuilder<T> {
    ...
    public static <T> ResponseEntity<T> build(IRet ret) {
        return build(ret, HttpStatus.OK);
    }

    public static <T> ResponseEntity<T> build(IRet ret, HttpStatus status) {
        return new ResponseEntity(new Message<>(ret), status);
    }

    public static <T> ResponseEntity<T> build(IRet ret, Object data) {
    ...
    public static <T> ResponseEntity<T> build(IRet ret, Object data, HttpStatus status) {
        return new ResponseEntity(new Message<>(ret, data), status);
    }

    public static <T> ResponseEntity<T> build(Object body, HttpStatus status) {
        return new ResponseEntity(new Message<>(body), status);
    }

    public static <T> ResponseEntity<T> build(Message<?> message) {
        return build(message, HttpStatus.OK);
    }

    public static <T> ResponseEntity<T> build(Message<?> message, HttpStatus status) {
    ...
    public static <T> ResponseEntity<T> build(String code, String errorMessage, HttpStatus status) {
